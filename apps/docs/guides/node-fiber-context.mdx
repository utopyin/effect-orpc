---
title: "Node fiber context bridge"
description: "Propagate Effect FiberRefs across Node AsyncLocalStorage boundaries."
icon: "bridge"
---

The `/node` entrypoint installs an `AsyncLocalStorage` bridge for Effect `FiberRefs`.
...
See the [Hono guide](/guides/hono) for a concrete framework integration.
