...
> {
  ...
  >["$input"];
  /**
   * This property holds the upstream oRPC options and the Effect runtime,
   * error map, and tracing metadata used by Effect procedures.
   */
  ...
  >["router"];
  /**
   * Create a lazy router and applies all of the previously defined options to it.
   *
   * @see {@link https://orpc.dev/docs/router#extending-router Extending Router Docs}
   */
